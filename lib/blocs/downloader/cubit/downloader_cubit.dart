...
import 'package:beatwave/services/download/rust_download_service.dart';
import 'package:beatwave/src/rust/api/downloader/types.dart';
import 'package:beatwave/utils/download_types.dart';
...
class DownloaderCubit extends Cubit<DownloaderState> {
  ...
  Future<void> _initializeDownloadService() async {
    ...
    await _downloadService.initialize(
      ...
      tempDir: path.join(tempDirectory.path, 'beatwave_downloads'),
    );
