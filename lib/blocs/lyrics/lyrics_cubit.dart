...
import 'package:beatwave/core/models/exported.dart' hide Lyrics;
import 'package:beatwave/core/models/lyrics_models.dart';
import 'package:beatwave/services/db/dao/lyrics_dao.dart';
import 'package:beatwave/services/db/dao/settings_dao.dart';
import 'package:beatwave/services/meta_resolver/cross_plugin_resolver.dart';
import 'package:beatwave/services/plugin/plugin_service.dart';
import 'package:beatwave/src/rust/api/plugin/commands.dart';
import 'package:beatwave/src/rust/api/plugin/models.dart' as plugin_models;
...
class LyricsCubit extends Cubit<LyricsState> {
  ...
  LyricsCubit(
    ...
    _mediaItemSubscription =
        playerCubit.beatwavePlayer.mediaItem.stream.listen((item) {
      if (item != null) {
