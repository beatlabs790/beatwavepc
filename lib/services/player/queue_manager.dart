...
/// The [BeatWaveMusicPlayer] reads [currentTrack] after calling navigation
...
class QueueManager {
  ...
  /// [BeatWaveMusicPlayer] checks this to skip the persistence listener
  ...
  ///
  /// Called from [BeatWaveMusicPlayer] via a throttled listener on
