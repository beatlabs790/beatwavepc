...
import 'package:beatwave/services/player/media_resolver_service.dart';
import 'package:beatwave/services/player/player_engine.dart';
import 'package:beatwave/services/player/player_error_handler.dart';
import 'package:beatwave/services/player/queue_manager.dart';
import 'package:beatwave/services/player/related_songs_manager.dart';
import 'package:beatwave/services/player/recently_played_tracker.dart';
...
class BeatWaveMusicPlayer extends BaseAudioHandler
  ...
  Future<void> _restoreLastSession() async {
    ...
    try {
      ...
      log('Session restore failed: $e', name: 'BeatWaveMusicPlayer');
    }
  }
  ...
  void _resumePlaybackAfterInterruption() {
    _activateAudioSession().then((granted) {
      ...
      log('Resume after interruption failed: $e', name: 'BeatWaveMusicPlayer');
    });
  }
  ...
  Future<bool> _activateAudioSession() async {
    try {
      ...
      log('setActive(true) failed: $e', name: 'BeatWaveMusicPlayer');
      return false;
    }
  }
  ...
  Future<void> _restoreEngineSettings() async {
    try {
      ...
      log('restoreEngineSettings failed: $e', name: 'BeatWaveMusicPlayer');
    }
  }
  ...
  void _initSubscriptions() {
    ...
    _errorSub = engine.errorStream.listen((error) {
      log('Engine error: $error', name: 'BeatWaveMusicPlayer');
      final track = _queueManager.currentTrack;
      if (track != null) {
  ...
  Future<void> _doPlay(
    ...
    try {
      ...
      log('Play failed: ${track.title}: $e',
          name: 'BeatWaveMusicPlayer', stackTrace: stack);
      _errorHandler.handleError(
  ...
  Future<void> revive() async {
    ...
    log('Reviving BeatWaveMusicPlayer...', name: 'BeatWaveMusicPlayer');
