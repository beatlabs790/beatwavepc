...
import 'package:beatwave/blocs/local_music/cubit/local_music_cubit.dart';
import 'package:beatwave/blocs/lyrics/lyrics_cubit.dart';
...
import 'package:beatwave/blocs/explore/cubit/recently_cubit.dart';
...
import 'package:beatwave/repository/beatwave/download_repository.dart';
...
import 'package:beatwave/services/db/dao/download_dao.dart';
import 'package:beatwave/services/db/dao/history_dao.dart';
import 'package:beatwave/services/db/dao/lyrics_dao.dart';
import 'package:beatwave/services/db/dao/notification_dao.dart';
import 'package:beatwave/services/db/dao/library_dao.dart';
import 'package:beatwave/services/db/dao/playlist_dao.dart';
import 'package:beatwave/services/db/dao/search_history_dao.dart';
...
import 'package:beatwave/blocs/timer/timer_bloc.dart';
import 'package:beatwave/screens/widgets/global_event_listener.dart';
import 'package:beatwave/screens/widgets/shortcut_indicator_overlay.dart';
import 'package:beatwave/screens/widgets/snackbar.dart';
import 'package:beatwave/services/bootstrap.dart';
import 'package:beatwave/services/audio_service_initializer.dart';
import 'package:beatwave/services/keyboard_shortcuts_service.dart';
...
import 'package:beatwave/routes/app_router.dart';
...
import 'package:beatwave/services/discord_service.dart';
import 'package:beatwave/services/db/legacy/legacy_migration_service.dart'
    as legacy_migration;
import 'package:beatwave/screens/widgets/legacy_migration_overlay.dart';
import 'package:beatwave/screens/widgets/onboarding_overlay.dart';
import 'package:beatwave/screens/widgets/plugin_bootstrap_overlay.dart';
import 'package:beatwave/services/onboarding_service.dart';
import 'package:beatwave/services/plugin_bootstrap_service.dart';
import 'package:beatwave/plugins/services/plugin_repository_service.dart';
import 'package:beatwave/services/shared_url_resolver_service.dart';
...
Future<void> _handleYoutubeVideoIntent(String url) async {
  ...
  if (result.status == SharedUrlResolveStatus.success && track != null) {
    final player = await PlayerInitializer().getBeatWaveMusicPlayer();
...
late BeatWavePlayerCubit beatwavePlayerCubit;
Future<void> setupPlayerCubit() async {
  await setupAudioSession();
  final player = await PlayerInitializer().getBeatWaveMusicPlayer();
  beatwavePlayerCubit = BeatWavePlayerCubit(player);
}
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => beatwavePlayerCubit,
          lazy: false,
        ),
        BlocProvider(
            create: (context) =>
                MiniPlayerCubit(playerCubit: beatwavePlayerCubit),
            lazy: true),
        BlocProvider(
        ...
        BlocProvider(
            create: (context) => TimerBloc(
                ticker: const Ticker(), beatwavePlayer: beatwavePlayerCubit)),
        BlocProvider(
        ...
        BlocProvider(
          create: (context) => LastdotfmCubit(
            playerCubit: beatwavePlayerCubit,
      ...
      child: BlocBuilder<BeatWavePlayerCubit, BeatWavePlayerState>(
        builder: (context, state) {
          if (state is BeatWavePlayerInitial) {
            return const Center(
              child: SizedBox(
                width: 50,
                height: 50,
