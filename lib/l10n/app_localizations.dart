...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'I want BeatWave to keep improving.'**
  ...
  /// No description provided for @importBeatWaveFiles.
  ///
  /// In en, this message translates to:
  /// **'Import BeatWave Files'**
  String get importBeatWaveFiles;
