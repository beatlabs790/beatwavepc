...
class _UpNextPanelState extends State<UpNextPanel> {
  ...
  late final BeatWavePlayerCubit _playerCubit;

  @override
  void initState() {
    super.initState();
    _playerCubit = context.read<BeatWavePlayerCubit>();
...
class _PanelContent extends StatelessWidget {
  ...
  final BeatWavePlayerCubit playerCubit;
      ...
      child: Row(
        ...
        children: [
          StreamBuilder<List<MediaItem>>(
            stream: playerCubit.beatwavePlayer.queue,
...
class _ClearQueueButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => playerCubit.beatwavePlayer.clearQueue(),
      child: Container(
...
class _DesktopSongListState extends State<_DesktopSongList> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MediaItem>>(
      stream: widget.playerCubit.beatwavePlayer.queue,
      builder: (context, queueSnapshot) {
        ...
        return StreamBuilder<MediaItem?>(
          stream: widget.playerCubit.beatwavePlayer.mediaItem,
          builder: (context, mediaSnapshot) {
            ...
            return ReorderableListView.builder(
              ...
              onReorder: widget.playerCubit.beatwavePlayer.moveQueueItem,
...
class _QueueItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget content = Dismissible(
      ...
      onDismissed: (_) => playerCubit.beatwavePlayer.removeQueueItemAt(index),
      child: Material(
        color: Colors.transparent,
        child: Padding(
            ...
            children: [
              Expanded(
                child: SongCardWidget(
                  showOptions: false,
                  onTap: () => playerCubit.beatwavePlayer.skipToQueueItem(index),
                  song: songModel,
                  trailing: IconButton(
